...
export type VatScheme = "STANDARD" | "MARGIN" | "FULL_SALE";
...
export type CommercialDocumentMeta = {
  ...
  vehicleId?: string;
  vehicleLabel?: string;
  /** โหมด VAT: STANDARD=ยอดก่อน VAT+7%, MARGIN=ป.111 จากกำไร, FULL_SALE=จากยอดขายรวม */
  vatScheme?: VatScheme;
...
export function defaultPaymentVoucherMeta(): PaymentVoucherMeta {
  return {
    payeeName: "",
    payeeAddress: "",
    payeeTaxId: "",
