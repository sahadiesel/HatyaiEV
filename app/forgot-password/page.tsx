...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-10">
      ...
      <p className="mt-1 text-sm text-slate-600">กรอกอีเมลที่ลงทะเบียนไว้ เพื่อรับลิงก์รีเซ็ตรหัสผ่าน</p>
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4 rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
        <label className="block text-sm">
          ...
          <input name="email" type="email" required autoComplete="email" className={inp} placeholder="name@example.com" />
        </label>
